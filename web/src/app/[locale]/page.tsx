    ...
    <div className="glass-container" dir={language === "ar" ? "rtl" : "ltr"} style={{ display: "flex", flexDirection: "column", minHeight: "100vh", position: "relative" }}>
      ...
      <main id="overview" className="glass-hero-section" style={{ zIndex: 1, padding: "90px 1.5rem 1rem 1.5rem", maxWidth: "1200px", margin: "0 auto", width: "100%", scrollMarginTop: "100px" }}>
        <div className="glass-card" style={{ background: "rgba(255, 255, 255, 0.45)", backdropFilter: "blur(20px)", border: "1px solid var(--card-border)", borderRadius: "var(--border-radius-lg)", padding: "1.25rem 2rem", boxShadow: "var(--shadow-lg)", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.75rem" }}>
          ...
          {/* Elegant tab selectors to switch between Google & Phone methods */}
          <div className="auth-tab-container" style={{ display: "flex", gap: "0.5rem", background: "rgba(255, 255, 255, 0.65)", border: "1px solid rgba(226, 232, 240, 0.8)", borderRadius: "30px", padding: "4px", width: "100%", maxWidth: "340px", margin: "0.5rem 0", boxShadow: "inset 0 2px 4px rgba(0,0,0,0.02)" }}>
            <button
              ...
              style={{
                ...
                color: activeTab === "google" ? "#ffffff" : "var(--foreground)",
                fontSize: "0.88rem",
                fontWeight: 600,
                cursor: "pointer",
                transition: "all 0.25s cubic-bezier(0.4, 0, 0.2, 1)",
                boxShadow: activeTab === "google" ? "0 4px 12px rgba(37, 99, 235, 0.2)" : "none",
                transform: activeTab === "google" ? "scale(1.02)" : "scale(1)",
              }}
            >
              <svg className="google-icon-svg" viewBox="0 0 24 24" width="14" height="14" xmlns="http://www.w3.org/2000/svg" style={{ filter: activeTab === "google" ? "brightness(0) invert(1)" : "none", transition: "filter 0.25s" }}>
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4" />
                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853" />
                <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z" fill="#FBBC05" />
                <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335" />
              </svg>
              <span>{t("tab_google")}</span>
            </button>
            <button
              ...
              style={{
                ...
                borderRadius: "26px",
                border: "none",
                background: activeTab === "phone" ? "var(--primary)" : "transparent",
                color: activeTab === "phone" ? "#ffffff" : "var(--foreground)",
                fontSize: "0.88rem",
                fontWeight: 600,
                cursor: "pointer",
                transition: "all 0.25s cubic-bezier(0.4, 0, 0.2, 1)",
                boxShadow: activeTab === "phone" ? "0 4px 12px rgba(37, 99, 235, 0.2)" : "none",
                transform: activeTab === "phone" ? "scale(1.02)" : "scale(1)",
              }}
            >
              <FiPhone style={{ fontSize: "0.95rem" }} />
          ...
          {activeTab === "phone" && (
            <div style={{ width: "100%", maxWidth: "340px", display: "flex", flexDirection: "column", gap: "0.75rem", marginTop: "0.5rem", textAlign: "left" }}>
              {!confirmationResult ? (
                /* Step 1: Request SMS code */
                <form onSubmit={handleSendCode} style={{ display: "flex", flexDirection: "column", gap: "0.75rem", width: "100%" }}>
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.35rem" }}>
                    <label style={{ fontSize: "0.85rem", fontWeight: 600, color: "var(--foreground)", opacity: 0.8 }}>
                      {t("phone_number_label")}
                    </label>
                    <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
                      <FiPhone style={{ position: "absolute", left: language === "ar" ? "auto" : "12px", right: language === "ar" ? "12px" : "auto", color: "var(--foreground)", opacity: 0.4, fontSize: "1rem", zIndex: 2 }} />
                      <input
                        type="tel"
                        dir="ltr"
                        value={phoneNumber}
                        ...
                        style={{
                          width: "100%",
                          padding: language === "ar" ? "0.6rem 2.2rem 0.6rem 1rem" : "0.6rem 1rem 0.6rem 2.2rem",
                          borderRadius: "10px",
                          ...
                          textAlign: "left", // Force phone typing to be LTR left-aligned
                        }}
                  ...
                  {/* Explicit normal reCAPTCHA container mounted securely under the input area */}
                  <div id="recaptcha-container" style={{ display: "flex", justifyContent: "center", margin: "0.5rem 0", minHeight: "78px" }}></div>
                  ...
                  >
                    <FiSend />
                    <span>{sendingCode ? t("btn_sending_code") : t("btn_send_code")}</span>
                  </button>
                </form>
              ) : (
                /* Step 2: Verify SMS code */
                <form onSubmit={handleVerifyCode} style={{ display: "flex", flexDirection: "column", gap: "0.75rem", width: "100%" }}>
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.35rem" }}>
                    <label style={{ fontSize: "0.85rem", fontWeight: 600, color: "var(--foreground)", opacity: 0.8 }}>
                      {t("verification_code_label")}
                    </label>
                    <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
                      <FiCheck style={{ position: "absolute", left: language === "ar" ? "auto" : "12px", right: language === "ar" ? "12px" : "auto", color: "var(--foreground)", opacity: 0.4, fontSize: "1rem", zIndex: 2 }} />
                      <input
                        type="text"
                        dir="ltr"
                        pattern="[0-9]*"
                        ...
                        style={{
                          ...
                          outline: "none",
                          transition: "border-color 0.2s, box-shadow 0.2s",
                          textAlign: "center", // Center-align the 6-digit pin code
                        }}
                        onFocus={(e) => e.target.style.borderColor = "var(--primary)"}
                        onBlur={(e) => e.target.style.borderColor = "var(--card-border)"}
                      />
                  ...
                  >
                    <FiCheck />
                    <span>{verifyingCode ? t("btn_verifying_code") : t("btn_verify_code")}</span>
                  </button>

                  <button
                    type="button"
                    onClick={handleResetPhoneAuth}
                    style={{
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
