...
The user has selected their preferred language as 'Arabic' (from the 7 languages we support: English, Arabic, French, German, Spanish, Italian, and Chinese).
You MUST speak, respond, and formulate all questions, validation feedback, and welcoming statements strictly and exclusively in 'Arabic' at all times. Do NOT randomly switch languages or translate things into other languages.
...
async function run() {
  console.log("Using model (Arabic):", modelName);

  const contents = [
    { role: "user", parts: [{ text: "[SYSTEM] Phone number verified: +201011223344" }] },
    { role: "user", parts: [{ text: "طالب" }] },
    { role: "model", parts: [{ text: "أهلاً بك يا بطل! ما هو اسمك الكامل؟ 👋\n[METADATA] state: {\"step\": \"name\", \"role\": \"student\", \"country\": \"\", \"name\": \"\", \"username\": \"\", \"age\": \"\", \"grade\": \"\"}" }] },
    { role: "user", parts: [{ text: "هشام أبو الفتوح" }] },
    { role: "model", parts: [{ text: "تشرفت بمعرفتك يا هشام! يرجى اختيار اسم مستخدم مميز ومتاح.\n[METADATA] state: {\"step\": \"username\", \"role\": \"student\", \"country\": \"\", \"name\": \"هشام أبو الفتوح\", \"username\": \"\", \"age\": \"\", \"grade\": \"\"}" }] },
    { role: "user", parts: [{ text: "hesham88" }] },
    { role: "model", parts: [{ text: "اسم المستخدم @hesham88 متاح وصالح! كم عمرك الآن؟\n[METADATA] state: {\"step\": \"age\", \"role\": \"student\", \"country\": \"\", \"name\": \"هشام أبو الفتوح\", \"username\": \"hesham88\", \"age\": \"\", \"grade\": \"\"}" }] },
    { role: "user", parts: [{ text: "15" }] },
    { role: "model", parts: [{ text: "رائع! ما هي بلد إقامتك حالياً؟\n[METADATA] state: {\"step\": \"country\", \"role\": \"student\", \"country\": \"\", \"name\": \"هشام أبو الفتوح\", \"username\": \"hesham88\", \"age\": \"15\", \"grade\": \"\"}" }] },
    { role: "user", parts: [{ text: "مصر" }] },
    { role: "model", parts: [{ text: "بناءً على عمرك (15 سنة) وإقامتك في مصر، نقترح عليك الصف الدراسي: **الصف الأول الثانوي**. هل تقبل هذا الاقتراح، أم تفضل كتابة صف مخصص، أو اختيار متعلم مدى الحياة، أو تخطي الخطوة؟\n[METADATA] state: {\"step\": \"grade\", \"role\": \"student\", \"country\": \"مصر\", \"name\": \"هشام أبو الفتوح\", \"username\": \"hesham88\", \"age\": \"15\", \"grade\": \"\"}" }] },
    { role: "user", parts: [{ text: "Accept recommended grade: الصف الأول الثانوي" }] }
  ];

  console.log("\n--- Sending Accept recommendation prompt (Arabic) ---");
