...
| **Audit Timestamp** | `2026-06-04T08:53:56.133019` |
...
| :--- | :--- | :--- |
| `scripts\ingestion\job_embed.py` | Competitor AI Dependency | Contains reference to unapproved third-party AI assistant/agent. |
