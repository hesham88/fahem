...
| **Audit Timestamp** | `2026-05-29T02:21:44.182525` |
...
- **Total Security/Exclusivity Issues**: **6** active findings.
...
| :--- | :--- | :--- |
| `scripts\manage_workspace.py` | Competitor AI Dependency | Contains reference to unapproved third-party AI assistant/agent. |
| `scripts\manage_workspace.py` | Competitor AI Dependency | Contains reference to unapproved third-party AI assistant/agent. |
| `scripts\manage_workspace.py` | Competitor AI Dependency | Contains reference to unapproved third-party AI assistant/agent. |
| `scripts\manage_workspace.py` | Competitor AI Dependency | Contains reference to unapproved third-party AI assistant/agent. |
| `scripts\manage_workspace.py` | Competitor AI Dependency | Contains reference to unapproved third-party AI assistant/agent. |
