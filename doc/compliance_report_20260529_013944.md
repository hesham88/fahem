...
| **Audit Timestamp** | `2026-05-29T01:39:44.100371` |
...
- **Total Security/Exclusivity Issues**: **44** active findings.
...
| `doc\compliance_report_20260529_013737.md` | Sensitive Information Leakage | Contains reference matching: Local Username (hesh1) |
...
| `memory\walkthrough_v16.md` | Sensitive Information Leakage | Contains reference matching: Local Username (hesh1) |
