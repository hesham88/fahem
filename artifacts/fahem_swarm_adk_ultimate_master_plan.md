...
To respect team protocols and avoid unaligned edits, we request your review of this comprehensive plan. Once you give the go-ahead, we can immediately begin writing code for **Milestone 1** (fixing the RTL nav collision in globals.css and wiring persistent onboarding verification state bypass)!
