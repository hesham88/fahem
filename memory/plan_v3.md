...
## Objective
Initialize the project infrastructure, layout, automation scripts, and next-generation Next.js web application hosted on Firebase for the **Fahem** project under strict security guidelines.
...
3. **Phase 3: Next.js Frontend & Firebase Hosting Development**
   * Bootstrap and build the Next.js web application in the `web/` folder
   * Configure Firebase CLI, initialization (`firebase.json`), and hosting setup
