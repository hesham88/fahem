# Project Walkthrough - Version 13
...
2. **Directory Roles**:
   ...
   * `agents/`: Multi-agent sandbox using the **Google Agent Development Kit (ADK)**. Contains custom agents (`Coordinator`, `StoryTeller`), schemas, and custom tools.
