...
3. **Phase 3: Next.js & Firebase App Hosting Development** (In Progress)
   * Bootstrap Next.js web application inside the `web/` folder using the **App Router** (without Tailwind CSS)
