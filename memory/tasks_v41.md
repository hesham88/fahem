...
| **TSK-022** | Synchronize package-lock.json peer dependencies | web | Completed | Agent | Force-regenerate `package-lock.json` with added `optionalDependencies` for kerberos/encryption |
