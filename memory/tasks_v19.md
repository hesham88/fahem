...
| **TSK-011** | Integrate GitHub auto-deployment setup | web/CI-CD | In Progress | User / Agent | Link GitHub repository to Firebase App Hosting for CD; push initial commit |
