# Project Walkthrough - Version 14
...
2. **Directory Roles**:
   ...
   * `doc/`: Holds Google Cloud Rapid Agent Hackathon PDF documents, rules, resources, and FAQ manuals.
   ...
   * `agents/`: Multi-agent sandbox using the **Google Agent Development Kit (ADK)**. Scaffolded to integrate the **MongoDB MCP server** for database interaction.
