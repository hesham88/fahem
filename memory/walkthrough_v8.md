...
2. **Directory Roles**:
   ...
   * `security/`: Holds safety rules, including sensitive data masking (usernames, tokens, URLs), Google Cloud Secret Manager policy, and authorized Git committer details.
...
## Revision History
* **v8.0** (2026-05-29): Added Git remote repository config description.
* **v7.0** (2026-05-29): Added local git repository walkthrough and user identity settings.
