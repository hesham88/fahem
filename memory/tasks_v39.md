# Task List - Version 39
**Timestamp**: 2026-05-29T07:16:00+03:00
...
| **TSK-019** | Deploy MongoDB MCP service to Cloud Run | web/agents | In Progress | Agent | Deploying containerized ADK API Server with MongoDB MCP to Cloud Run in `us-east4` |
| **TSK-020** | Enforce Private Cloud Run Access & OAuth2 ID token auth | web/agents | In Progress | Agent | Configured `--no-allow-unauthenticated` on Cloud Run and added Google OAuth2 / OIDC token injection |
