# Project Walkthrough - Version 15
...
2. **Directory Roles**:
   ...
   * `agents/`: Multi-agent sandbox using the **Google Agent Development Kit (ADK)**. Scaffolded to integrate the **MongoDB MCP server** for database interaction. Contains the compliance agent usage manual `compliance_agent_guide.md`.
